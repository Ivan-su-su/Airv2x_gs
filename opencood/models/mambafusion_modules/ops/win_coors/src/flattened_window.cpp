...
std::vector<at::Tensor> map_points_multi_view(
    at::Tensor points,
    at::Tensor lidar2image,
    at::Tensor image_aug_matrix,
    int batch_size,
    ...
    return map_points_multi_view_cuda(
        points,
        lidar2image,
        image_aug_matrix,
        batch_size,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("map_points_multi_view", &map_points_multi_view, "Map Points Multi View (CUDA)");
