...
(tau=1). RSU collated extrinsics are lidar-to-camera; vehicle/drone stay
camera-to-lidar (``project_box_to_image`` inverts).
"""
...
# RSU stacked extrinsics behave as lidar-to-camera; the helper inverts cam2lidar.
LIDAR2CAM_STORED = {"vehicle": False, "rsu": True, "drone": False}
